...
export default function StorySection() {
    return (
        <section id="my-story" className="py-24 bg-slate-50 overflow-hidden font-subject">
            <div className="max-w-6xl mx-auto px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <FadeInOnView direction="left" className="relative group">
                        ...
                        <div className="absolute -bottom-6 -right-6 -z-10 h-32 w-32 rounded-full bg-blue-100 blur-2xl" />
                    </FadeInOnView>

                    {/* Content Column */}
                    <div className="flex flex-col">
                        <FadeInOnView>
                            <h2 className="text-4xl font-bold mb-6 font-durer text-slate-900 border-l-4 border-blue-600 pl-4">
                                My Story
                            </h2>
                        </FadeInOnView>
                        ...
                        <div className="space-y-4 text-slate-600 leading-relaxed text-justify">
                            <p>
                                Hi, I&apos;m <span className="font-bold text-blue-700">Phanlop Boonluea</span>, a Computer Engineering student
                                at&nbsp;
                                <a
                            ...
                            <p>
                                In 2024, I chose to pursue <span className="text-slate-900 font-semibold">Computer Engineering</span> to master both hardware and software. 
                        ...
                        <div className="mt-8 p-4 bg-white rounded-lg border border-slate-100 shadow-sm inline-flex items-center gap-3 w-fit">
